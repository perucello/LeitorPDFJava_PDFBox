...
public class LeitorPDFJava {
	 ...
	 * 
	 * Você deve validar o ClassPath, para isso acesse Propriedades, Project, Add e referencie o Projeto
	 * Você deve adicionar o Jar do PDFBox, para isso acesse Propiedades, Library, Add External Jar e aponte para o jar do PDFBox baixado
	 */
	...
	public static void main(String[] args) {
		...
		String arquivo = "TestePDF.pdf"; //criamos um arquivo PDF , pelo WORD salvamos arquivo com extensão PDF para teste, mas você pode apontar para seu documento com extensão PDF
